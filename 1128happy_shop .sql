...
(1, 'https://github.com/SiangTu/shoppingApp/blob/thor/img/%E8%8C%B6%E8%91%89%E6%9E%95%E9%A0%AD%E5%B0%81%E9%9D%A2.jpg?raw=true');
...
(1, 980, 1, '台北市德惠街173號五樓', 25961396, '2009-11-10', '	{ 987654321 : \r\n						info [ { \r\n							name : “可樂”,\r\n							price : 20,\r\n							quantity :  3,\r\n							media_info : “https://coca.png”\r\n							  },\r\n							{ \r\n							name : “熱狗”,\r\n							price : 30,\r\n							quantity :  5,\r\n							media_info : “https://hotdog.png”\r\n							} ]\r\n					}\r\n	}	'),
(2, 4300, 2, '台北市德惠街173號', 912123123, '2021-11-11', '	{ 987654321 : \r\n						info [ { \r\n							name : “可樂”,\r\n							price : 20,\r\n							quantity :  3,\r\n							media_info : “https://coca.png”\r\n							  },\r\n							{ \r\n							name : “熱狗”,\r\n							price : 30,\r\n							quantity :  5,\r\n							media_info : “https://hotdog.png”\r\n							} ]\r\n					}\r\n	}	'),
(3, 16000, 2, '台北市大安區基隆路2號', 912123123, '2021-11-17', '	{ 987654321 : \r\n						info [ { \r\n							name : “可樂”,\r\n							price : 20,\r\n							quantity :  3,\r\n							media_info : “https://coca.png”\r\n							  },\r\n							{ \r\n							name : “熱狗”,\r\n							price : 30,\r\n							quantity :  5,\r\n							media_info : “https://hotdog.png”\r\n							} ]\r\n					}\r\n	}	'),
(4, 288, 3, '台北市興隆路123號', 91212346, '2021-11-17', '	{ 987654321 : \r\n						info [ { \r\n							name : “可樂”,\r\n							price : 20,\r\n							quantity :  3,\r\n							media_info : “https://coca.png”\r\n							  },\r\n							{ \r\n							name : “熱狗”,\r\n							price : 30,\r\n							quantity :  5,\r\n							media_info : “https://hotdog.png”\r\n							} ]\r\n					}\r\n	}	'),
(5, 1299, 5, '台北市興隆路1113號', 91212346, '2021-11-17', '	{ 987654321 : \r\n						info [ { \r\n							name : “可樂”,\r\n							price : 20,\r\n							quantity :  3,\r\n							media_info : “https://coca.png”\r\n							  },\r\n							{ \r\n							name : “熱狗”,\r\n							price : 30,\r\n							quantity :  5,\r\n							media_info : “https://hotdog.png”\r\n							} ]\r\n					}\r\n	}	'),
(6, 1299, 5, '台北市興隆路1113號', 91212346, '2021-11-17', '	{ 987654321 : \r\n						info [ { \r\n							name : “可樂”,\r\n							price : 20,\r\n							quantity :  3,\r\n							media_info : “https://coca.png”\r\n							  },\r\n							{ \r\n							name : “熱狗”,\r\n							price : 30,\r\n							quantity :  5,\r\n							media_info : “https://hotdog.png”\r\n							} ]\r\n					}\r\n	}	'),
(7, 3600, 7, '花蓮縣伯朗大道一號', 912123355, '2021-11-17', '	{ 987654321 : \r\n						info [ { \r\n							name : “可樂”,\r\n							price : 20,\r\n							quantity :  3,\r\n							media_info : “https://coca.png”\r\n							  },\r\n							{ \r\n							name : “熱狗”,\r\n							price : 30,\r\n							quantity :  5,\r\n							media_info : “https://hotdog.png”\r\n							} ]\r\n					}\r\n	}	'),
(8, 240000, 8, '台北市信義區101 100號83樓', 912123329, '2022-11-18', '	{ 987654321 : \r\n						info [ { \r\n							name : “可樂”,\r\n							price : 20,\r\n							quantity :  3,\r\n							media_info : “https://coca.png”\r\n							  },\r\n							{ \r\n							name : “熱狗”,\r\n							price : 30,\r\n							quantity :  5,\r\n							media_info : “https://hotdog.png”\r\n							} ]\r\n					}\r\n	}	'),
(9, 3600, 9, '花蓮縣伯朗大道三賀', 912123323, '2021-11-18', '	{ 987654321 : \r\n						info [ { \r\n							name : “可樂”,\r\n							price : 20,\r\n							quantity :  3,\r\n							media_info : “https://coca.png”\r\n							  },\r\n							{ \r\n							name : “熱狗”,\r\n							price : 30,\r\n							quantity :  5,\r\n							media_info : “https://hotdog.png”\r\n							} ]\r\n					}\r\n	}	'),
(10, 24000, 10, '台北市信義區101 100號87樓', 912123329, '2022-11-18', '	{ 987654321 : \r\n						info [ { \r\n							name : “可樂”,\r\n							price : 20,\r\n							quantity :  3,\r\n							media_info : “https://coca.png”\r\n							  },\r\n							{ \r\n							name : “熱狗”,\r\n							price : 30,\r\n							quantity :  5,\r\n							media_info : “https://hotdog.png”\r\n							} ]\r\n					}\r\n	}	');
...
CREATE TABLE `product_info` (
  ...
  `detail` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `vendor_id` int(10) NOT NULL,
  `picture` varchar(100) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `payment` varchar(10) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `delivery` varchar(10) COLLATE utf8mb4_unicode_520_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
INSERT INTO `product_info` (`item_id`, `name`, `price`, `quantity`, `detail`, `vendor_id`, `picture`, `payment`, `delivery`) VALUES
(1, '常香健枕頭-弘道實業有限公司出品', 980, 999, '枕頭', 1, '', '現金', '宅配'),
(2, '常香健雙人加大床墊-弘道實業有限公司出品', 4300, 9999, '床墊', 1, '', '現金', '宅配'),
(3, '常香健雙人床墊-弘道實業有限公司出品', 3600, 9999, '床墊', 1, '', '現金', '宅配'),
(4, '常香健超強除鞋臭茶香包-弘道實業有限公司出品', 599, 99999999, '除鞋臭', 1, '', '現金', '宅配'),
(5, '常香健鐵觀音抱枕-弘道實業有限公司出品', 288, 99999999, '全球獨家茶葉抱枕', 1, '', '現金', '宅配'),
(6, '常香健鐵觀音頭枕-弘道實業有限公司出品', 288, 99999999, '全球獨家茶葉頭枕', 1, '', '現金', '宅配'),
(7, '常香健鐵觀音頭枕-弘道實業有限公司出品', 288, 99999999, '全球獨家茶葉頭枕', 1, '', '現金', '宅配'),
(8, '常香健鐵觀音透氣座墊-弘道實業有限公司出品', 1299, 99999999, '坐墊', 1, '', '現金', '宅配'),
(9, '常香健鐵觀音透氣沙發座墊-弘道實業有限公司出品', 1299, 99999999, '坐墊', 1, '', '現金', '宅配'),
(10, '常香健鐵觀音超值11件車墊高級套裝組-弘道實業有限公司出品', 16000, 99999999, '車墊', 1, '', '現金', '宅配');
